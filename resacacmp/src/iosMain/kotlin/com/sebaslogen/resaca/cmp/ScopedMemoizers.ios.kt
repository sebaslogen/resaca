...
public actual fun <T : Any, K : Any> rememberScoped(key: K, keyInScopeResolver: KeyInScopeResolver<K>, builder: @DisallowComposableCalls () -> T): T =
    rememberScopedResaca(key, keyInScopeResolver, builder)
...
): T = viewModelScopedResaca(key, keyInScopeResolver, defaultArguments)
...
): T = viewModelScopedResaca(key, keyInScopeResolver, defaultArguments, builder)
