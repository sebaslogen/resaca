...
val appModule = module {
    ...
    viewModelOf(::FakeScopedViewModel)
...
//    you can use the constructor below to pass arguments at call site (assisted injection)
    viewModel { (counter: AtomicInteger) -> // Assisted injection of viewModelsClearedCounter constructor parameter
        FakeInjectedViewModel(stateSaver = get(), repository = get(), viewModelsClearedCounter = counter)
    }
}